		...
		private void Update()
		{
			if (ReInput.isReady)
			{
				...
				if (player.GetButtonDown("Fire"))
				{
					...
					Object.Instantiate(bulletPrefab, base.transform.position + vector2, Quaternion.identity).GetComponent<Rigidbody>().linearVelocity = new Vector3(bulletSpeed * base.transform.right.x, 0f, 0f);
				}
