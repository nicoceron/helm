...
namespace Rewired.Utils
{
	...
	public class ExternalTools : IExternalTools
	{
		...
		#else
			// The recovered package only contains Rewired's optional Windows native
			// backend. Other desktop targets intentionally use Rewired's Unity-input
			// fallback instead of trying to load user32.dll.
			return null;
		#endif
		}
